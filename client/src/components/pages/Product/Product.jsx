...
export default function Product() {
  ...
  const handleBuyNow = (product) => {
    const phoneNumber = '9843542042'; // Replace with your phone number
  ...
  return (
    <div>
      <div className="container-fluid bg-breadcrumbsone">
      ...
      <div className="container-fluid service py-5">
        <div className="container py-5">
          <div className="section-title mb-5 wow fadeInUp" data-wow-delay="0.2s">
            ...
            <p className="mb-0">Experience the transformative power of Ayurvedic solutions curated by Dr. S. Kathija Nachiar, offering holistic remedies for anti-aging, digestive health, orthopedic concerns, and more.
