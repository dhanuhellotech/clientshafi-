        ...
        <div className="row">
            ...
            <div className="first">
              ...
              <div className="footer-links">
                <ul>
                  ...
                  <li>
                    <Link to="/contact" className="d-block mb-2 link-color">Contact us</Link>
                  </li>
                  <li>
          ...
          <div className="col-lg-4 col-md-12 col-sm-12">
            <div className="second">
              ...
              <ul>
                <li>
                  <a href><i className="fa fa-map-marker-alt me-2" /> SHAFI Acupuncture & Ayurvedic, 470, W First Cross St, Mellur, KK Nagar, Madurai, Tamil Nadu 625020</a>
                </li>
                <li>
