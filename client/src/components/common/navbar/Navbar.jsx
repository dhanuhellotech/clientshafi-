      ...
      <div className="container-fluid position-relative p-0 ">
        <nav className="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
          ...
          <div className="collapse navbar-collapse" id="navbarCollapse" style={{ display: navstate ? "block" : "none" }}>
            ...
            <div class="dropdowns  d-flex justify-content-center mt-3 mt-lg-0">
              <div className='dropdown-new'>
              <button class="btn btn-primary rounded-pill text-white py-2 px-4 flex-wrap flex-sm-shrink-0 dropdown-toggle mr-2 mb-2" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Book Appointment
              </button>
